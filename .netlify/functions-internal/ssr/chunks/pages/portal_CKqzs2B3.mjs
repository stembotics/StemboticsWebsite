...
import 'kleur/colors';
import { a as $$PageHeader, $ as $$Shape } from './_category__BWdfZzMb.mjs';
import { createRequire } from 'module';
import { b as getEntryBySlug, a as $$Base } from './404_Ce0m3FIs.mjs';
import { N as Notice } from './index_Cs8qHNvV.mjs';
...
const $$Portal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const stripe = require2("stripe")("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");
