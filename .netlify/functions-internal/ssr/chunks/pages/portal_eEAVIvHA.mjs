...
import 'kleur/colors';
import { a as $$PageHeader, $ as $$Shape } from './_category__QxcF0r5b.mjs';
import { createRequire } from 'module';
import { b as getEntryBySlug, a as $$Base } from './404_3uU1bBY2.mjs';
import { N as Notice } from './index_DgpoPP_-.mjs';
...
const $$Portal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const stripe = require2("stripe")(process.env.VITE_STRIPE_KEY);
