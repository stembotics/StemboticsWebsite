...
import 'kleur/colors';
import { c as getTaxonomy, g as getSinglePage, $ as $$Shape, a as $$PageHeader } from './_category__jFegd4Tz.mjs';
import { h as humanize, b as getEntryBySlug, a as $$Base } from './404_ZRzUwij7.mjs';
...
const PricingCard = ({ item }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "mt-8 px-1 md:col-3 lg:col-6 lg:mt-0", children: /* @__PURE__ */ jsxs(
    "div",
    {
