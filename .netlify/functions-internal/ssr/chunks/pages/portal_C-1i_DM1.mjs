...
import 'kleur/colors';
import { a as $$PageHeader, $ as $$Shape } from './_category__BU85fUT9.mjs';
import { createRequire } from 'module';
import { b as getEntryBySlug, a as $$Base } from './404_CQftGjMR.mjs';
import { N as Notice } from './index_B3YeJ0_g.mjs';
...
const $$Portal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const stripe = new Stripe({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://stembotics.org", "ASSETS_PREFIX": undefined}.VITE_STRIPE_KEY);
