/* empty css                              */
import { d as createAstro, e as createComponent, r as renderTemplate, h as renderComponent, g as addAttribute, m as maybeRenderHead } from '../astro_CTCjbM0q.mjs';
import 'kleur/colors';
import { a as $$PageHeader, $ as $$Shape } from './_category__Dsv6RSmS.mjs';
import { createRequire } from 'module';
import { b as getEntryBySlug, a as $$Base } from './404_Bg161Ur7.mjs';
import { N as Notice } from './index_DsF6-AL3.mjs';
...
const $$Portal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": portal.data.title, "meta_title": portal.data.meta_title, "description": portal.data.description, "image": portal.data.image }, { "default": ($$result2) => renderTemplate(_a || (_a = __template([" ", " ", '<section class="page-hero py-16"> <div class="container"> <div class="page-hero-content mx-auto max-w-[768px] text-center"> ', " ", " ", " ", " ", " ", " <p>Your next class starts on the next ", ' after June 1st, 2024.</p> <br> </div> <!-- benifit --> <div class="page-hero-content mx-auto max-w-[768px] text-center"> <h2>Available programs for ', "</h2> <p>Choose the program that best suits your needs</p> ", ' <div class="mt-11 justify-center sm:flex"> <a class="btn m-3 block sm:inline-block"', '>\nManage Billing\n</a> </div> <div class="buy-buttons"> <script async src="https://js.stripe.com/v3/buy-button.js"></script> ', ' <script async src="https://js.stripe.com/v3/buy-button.js">\n</script> ', ' <script async src="https://js.stripe.com/v3/buy-button.js">\n          </script> ', ' <script async src="https://js.stripe.com/v3/buy-button.js">\n            </script> ', " </div> </div> <br> </div> </section> "])), renderComponent($$result2, "Shape", $$Shape, {}), maybeRenderHead(), renderComponent($$result2, "PageHeader", $$PageHeader, { "page_data": page_data }), products.includes("VEX IQ Plan") && renderTemplate`${renderComponent($$result2, "Notice", Notice, { "type": "note" }, { "default": ($$result3) => renderTemplate`Congratulations! ${child_name} is registered in the VEX Learning plan, you now have access to the VEX Competition Plan.` })}`, products.includes("FLL Plan") && renderTemplate`${renderComponent($$result2, "Notice", Notice, { "type": "note" }, { "default": ($$result3) => renderTemplate`Congratulations! ${child_name} is registered in the FLL Learning plan, you now have access to the FLL Competition Plan.` })}`, products.includes("vexComp") && renderTemplate`${renderComponent($$result2, "Notice", Notice, { "type": "note" }, { "default": ($$result3) => renderTemplate`Congratulations! ${child_name} is registered in the VEX Competition plan.` })}`, products.includes("fllComp") && renderTemplate`${renderComponent($$result2, "Notice", Notice, { "type": "note" }, { "default": ($$result3) => renderTemplate`Congratulations! ${child_name} is registered in the FLL Competition plan.` })}`, !products.includes("VEX IQ Plan") && !products.includes("FLL Plan") && renderTemplate`${renderComponent($$result2, "Notice", Notice, { "type": "note" }, { "default": ($$result3) => renderTemplate`Unfortunately ${child_name} isn't registered in anything, to get access to the Competition Packages, register for a Learning plan.` })}`, date, child_name, !(child_age >= 9 && child_age <= 14) && renderTemplate`${renderComponent($$result2, "Notice", Notice, { "type": "warning" }, { "default": ($$result3) => renderTemplate`${child_name} is not eligible for any of our programs right now. Sorry!` })}`, addAttribute(`${plink}`, "href"), !products.includes("VEX IQ Plan") && renderTemplate`${renderComponent($$result2, "stripe-buy-button", "stripe-buy-button", { "buy-button-id": "buy_btn_1PQvfaBacad2NXeVDy4OeBBx", "publishable-key": "pk_live_51P6aVDBacad2NXeVAfq9rBWO21sJ8rVicoGsTRMfa5OvmUeZmhYucMgCXYkZhiUH6ga8oRIK03PcnmzCxyMpcRk000p9aWnmDw", "customer-session-client-secret": `${CLIENT_SECRET}` })}`, products.includes("VEX IQ Plan") && renderTemplate`${renderComponent($$result2, "stripe-buy-button", "stripe-buy-button", { "buy-button-id": "buy_btn_1PIHohBacad2NXeVEWslv6sw", "publishable-key": "pk_live_51P6aVDBacad2NXeVAfq9rBWO21sJ8rVicoGsTRMfa5OvmUeZmhYucMgCXYkZhiUH6ga8oRIK03PcnmzCxyMpcRk000p9aWnmDw", "customer-session-client-secret": `${CLIENT_SECRET}` })}`, !products.includes("FLL Plan") && renderTemplate`${renderComponent($$result2, "stripe-buy-button", "stripe-buy-button", { "buy-button-id": "buy_btn_1PQvdyBacad2NXeVFHqgZcF6", "publishable-key": "pk_live_51P6aVDBacad2NXeVAfq9rBWO21sJ8rVicoGsTRMfa5OvmUeZmhYucMgCXYkZhiUH6ga8oRIK03PcnmzCxyMpcRk000p9aWnmDw", "customer-session-client-secret": `${CLIENT_SECRET}` })}`, products.includes("FLL Plan") && renderTemplate`${renderComponent($$result2, "stripe-buy-button", "stripe-buy-button", { "buy-button-id": "buy_btn_1PIHoCBacad2NXeV7kbhwxVT", "publishable-key": "pk_live_51P6aVDBacad2NXeVAfq9rBWO21sJ8rVicoGsTRMfa5OvmUeZmhYucMgCXYkZhiUH6ga8oRIK03PcnmzCxyMpcRk000p9aWnmDw", "customer-session-client-secret": `${CLIENT_SECRET}` })}`) })}`;
