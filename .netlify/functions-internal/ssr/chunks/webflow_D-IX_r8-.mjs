const id = "webflow.mdx";
						...
						const data = {name:"webflow",title:"Webflow Integrations",excerpt:"We are looking for a personal financial planning pro Certified Financial Planner preferred who will lead our client advising efforts. You will be a fiduciary who works",image:"/images/integrations/webflow.png",categories:["productivity"],button:{label:"integrate",link:"#"},draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/krithikalluri/Documents/GitHub/StemboticsWebsite/src/content/integrations/webflow.mdx",
							rawData: undefined,
						};
