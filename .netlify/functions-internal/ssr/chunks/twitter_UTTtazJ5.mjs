const id = "twitter.mdx";
						...
						const data = {name:"twitter",title:"Twitter Integrations",excerpt:"We are looking for a personal financial planning pro Certified Financial Planner preferred who will lead our client advising efforts. You will be a fiduciary who works",image:"/images/integrations/twitter.png",categories:["social media"],button:{label:"integrate",link:"#"},draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/krithikalluri/Documents/GitHub/StemboticsWebsite/src/content/integrations/twitter.mdx",
							rawData: undefined,
						};
