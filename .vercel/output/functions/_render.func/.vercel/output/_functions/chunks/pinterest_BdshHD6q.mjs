const id = "pinterest.mdx";
						...
						const data = {name:"pinterest",title:"Pinterest Integrations",excerpt:"We are looking for a personal financial planning pro Certified Financial Planner preferred who will lead our client advising efforts. You will be a fiduciary who works",image:"/images/integrations/pinterest.png",categories:["social media"],button:{label:"integrate",link:"#"},draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/krithikalluri/Documents/GitHub/StemboticsWebsite/src/content/integrations/pinterest.mdx",
							rawData: undefined,
						};
