const id = "youtube.mdx";
						...
						const data = {name:"youtube",title:"Youtube Integrations",excerpt:"We are looking for a personal financial planning pro Certified Financial Planner preferred who will lead our client advising efforts. You will be a fiduciary who works",image:"/images/integrations/youtube.png",categories:["streaming"],button:{label:"integrate",link:"#"},draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/krithikalluri/Documents/GitHub/StemboticsWebsite/src/content/integrations/youtube.mdx",
							rawData: undefined,
						};
