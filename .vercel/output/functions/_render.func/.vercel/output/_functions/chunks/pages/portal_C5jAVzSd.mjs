...
import 'kleur/colors';
import { a as $$PageHeader, $ as $$Shape } from './_category__aFVGMAJa.mjs';
import { createRequire } from 'module';
import { b as getEntryBySlug, a as $$Base } from './404_CNDTmIcj.mjs';
...
const $$Portal = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const stripe = require2("stripe")(process.env.STRIPE_KEY);
