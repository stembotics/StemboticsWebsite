const id = "facebook.mdx";
						...
						const data = {name:"facebook",title:"Facebook Integrations",excerpt:"We are looking for a personal financial planning pro Certified Financial Planner preferred  who will lead our client advising efforts. You will be a fiduciary who works",image:"/images/integrations/facebook.png",categories:["social media"],button:{label:"integrate",link:"#"},draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/krithikalluri/Documents/GitHub/StemboticsWebsite/src/content/integrations/facebook.mdx",
							rawData: undefined,
						};
