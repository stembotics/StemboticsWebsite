...
const _page24 = () => import('./pages/api/courses/time-slots.astro.mjs');
const _page25 = () => import('./pages/api/courses/_id_/available-slots.astro.mjs');
const _page26 = () => import('./pages/api/courses/_id_/sessions.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/courses/time-slots.ts", _page24],
    ["src/pages/api/courses/[id]/available-slots.ts", _page25],
    ["src/pages/api/courses/[id]/sessions.ts", _page26],
