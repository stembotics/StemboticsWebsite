...
// Helper function to get full email HTML
const getFullEmailHtml = (content: string) => {
  return baseTemplate.replace('{{content}}', content);
};

export const sendWelcomeStudentEmail = async (email: string, name: string) => {
...
export const sendWelcomeTeacherEmail = async (email: string, name: string) => {
...
export const sendCourseEnrollmentEmail = async (email: string, studentName: string, courseName: string) => {
...
export const sendCourseCreatedEmail = async (email: string, teacherName: string, courseName: string) => {
...
export const sendPurchaseReceiptEmail = async (buyerEmail: string, buyerName: string, productName: string, amount: number, orderId: string) => {
...
export const sendContactFormNotification = async (name: string, email: string, subject: string, message: string) => {
  // Send to admin
